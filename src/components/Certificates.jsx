      ...
      <div className="p-5 mt-5 rounded-md bg-fadeGray dark:bg-transparent">
        <VerticalTimeline>
          ...
          >
            ...
            <p className="text-gray">
              I work in a publishing company where I create and maintain websites for authors, books, and literary projects, turning creative ideas into engaging and professional digital experiences.
            </p>
            <div className="relative mt-5 group">
              <a
                href="public/certificates/Official Justme Certificate.pdf"
                className="cursor-pointer group"
              >
                <img
                  src="public/certificates/Official Justme Certificate-1.jpg"
                  className="transition-all duration-200 group-hover:scale-125"
                />
