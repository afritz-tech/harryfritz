...
function Drawer({ isShowDrawer, toggleDrawer }) {
  ...
  return (
    <div
      className={`${
        isShowDrawer ? "translate-y-0" : "-translate-y-[200rem]"
      } absolute left-0 right-0 bottom-0 top-0 overflow-y-auto overflow-x-hidden transition-all duration-300 bg-fadeGray dark:bg-darkBlue text-[#4b4b4b] dark:text-fadeGray flex flex-col px-56 max-[900px]:px-10  z-20`}
    >
