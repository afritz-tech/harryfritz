          ...
          >
            ...
            >
              <div>
                ...
                <ul className="ml-5 list-disc text-gray">
                  <li>
                    I work as a Web Developer in the publishing industry
                  </li>
                  <li>I design</li>
                  <li>I develop</li>
                  <li>and maintain professional websites for a publishing company, creating engaging digital experiences for authors, books, and publishing projects.</li>
                </ul>
              </div>
              <div>
                <h5 className="my-2 mt-5 text-xl font-bold">Technologies</h5>
